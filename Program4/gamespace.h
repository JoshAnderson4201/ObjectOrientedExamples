...
// Enum for exception handling
  ...
  enum ExceptionType {INVALID_GENERAL, INVALID_NAME, INVALID_RANK, INVALID_WPN, 
                      INVALID_DIR, INVALID_CELL};
  const int NUM_EX_TYPE = 6;
  const string EX_STR[NUM_EX_TYPE] = {"INVALID GENERAL ERROR", "INVALID NAME", "INVALID RANK",
                                     "INVALID WEAPON", "INVALID DIR", "INVALID CELL"};
